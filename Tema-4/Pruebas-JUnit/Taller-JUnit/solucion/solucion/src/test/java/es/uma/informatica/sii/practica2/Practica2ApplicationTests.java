...
/*
* Al hacer mvn test se genera en target un site con la cobertura de jacoco
* Si algún test  falla esto no se genera correctamente (mirar la configuración de jacoco en el pom.xml)
* Se me genera el .exec pero no se ejecuta para ejecutarlo hay que hacer lo siguiente:
* mvn jacoco:report
* */
...
public class Practica2ApplicationTests {
	...
	public class ListaVacia {
		...
		public void devuelveLista() {
			// Patron AAA o GWT de las pruebas, tienen tres partes
